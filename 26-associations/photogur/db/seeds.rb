...
# Picture.create!(title: "Guinea Pig", description: "A pepper for a hat", url: "http://cdn.cutestpaw.com/wp-content/uploads/2013/04/Guinea-pig-with-a-pepper-hat..jpg")
animal_tag = Tag.create(name: "animals")
food_tag = Tag.create(name: "food")

Picture.find_by(id: 3).tags << food_tag
